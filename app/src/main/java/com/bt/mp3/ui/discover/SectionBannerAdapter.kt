...
import com.bt.mp3.R
import com.bt.mp3.databinding.ItemSectionBannerBinding
import com.bt.mp3.model.SongItem

class SectionBannerAdapter : BaseRecyclerAdapter<SongItem, ItemSectionBannerBinding>(
    ...
    override fun getLayoutRes(viewType: Int): Int = R.layout.item_section_banner
}
