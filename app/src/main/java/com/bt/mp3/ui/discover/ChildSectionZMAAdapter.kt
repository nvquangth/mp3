...
import com.bt.mp3.R
import com.bt.mp3.databinding.ItemChildSectionZmaBinding
import com.bt.mp3.model.SongItem

class ChildSectionZMAAdapter : BaseRecyclerAdapter<SongItem, ItemChildSectionZmaBinding>(
    ...
    override fun getLayoutRes(viewType: Int): Int = R.layout.item_child_section_zma
}
